...
public class ViewInformationOld implements IView {

    @NotNull
    private final JavunoClientMVC<ViewInformationOld, ClientAppController> mvc;
    @NotNull
    ...
    public ViewInformationOld(@NotNull JavunoClientMVC<ViewInformationOld, ClientAppController> mvc) {
        this.mvc = mvc;
    ...
    @NotNull
    @Override
    public JavunoClientMVC<ViewInformationOld, ClientAppController> getMVC() {
        return mvc;
    }
